function foot() {
  ...
  <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
    <div class="md:flex md:justify-between">
      <div class="mb-6 md:mb-0">
        ...
        >
          ...
          <span
            class="self-center text-2xl font-semibold whitespace-nowrap text-white hover:text-[#F4D9A6]"
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          <h2 class="mb-6 text-sm font-semibold text-[#F4D9A6] uppercase">
            Project
          </h2>
    ...
    <hr class="my-6 border-[#F4D9A6] sm:mx-auto lg:my-8" />
    <div class="sm:flex sm:items-center sm:justify-between">
      ...
      <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
        <a
          ...
          target="_blank"
          class="text-white hover:text-[#F4D9A6]"
        >
          <svg
            class="w-4 h-4"
            aria-hidden="true"
